...
const Shop = () => {
  return (
    <main>
      ...
      <section className='last-color'>
        <div className="container pb-5">
          <div className="last_section">
            <div className="last_section-card">
              ...
              <h2>
                High Quality <span>crafted from top materials</span>
              </h2>
            </div>
            <div className="last_section-card">
              <div className="img_svg">
              ...
              <h2>
                Warranty Protection <span>Over 2 years</span>
              </h2>
            </div>
            <div className="last_section-card">
              <div className="img_svg">
              ...
              <h2>
                Free Shipping <span>Order over 150 $</span>
              </h2>
            </div>
            <div className="last_section-card">
              <div className="img_svg">
              ...
              <h2>
                24 / 7 Support <span>Dedicated support</span>
              </h2>
            </div>
          </div>
        </div>
